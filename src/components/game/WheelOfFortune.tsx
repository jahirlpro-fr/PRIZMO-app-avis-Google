...
import { ProgressBar } from "@/components/game/InstagramStep";
...
export function WheelOfFortune({ segments, onSpinComplete, wheelNumber, establishmentName, secondaryColor = "#ffffff" }: WheelOfFortuneProps) {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 prizmo-gradient">
            <ProgressBar step={3} />
            <Card className="w-full max-w-2xl shadow-2xl" style={{ backgroundColor: secondaryColor }}>
