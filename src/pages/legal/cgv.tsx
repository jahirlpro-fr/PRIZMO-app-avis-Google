            ...
            <section style={{ padding: "0 24px 96px" }}>
                <div className="container-sm">
                    <div style={{ background: "white", border: "1.5px solid #efefef", borderRadius: "24px", padding: "48px", marginBottom: "32px" }}>
                        ...
                        <ul>
                            <li><strong>SOLO — 49€ HT/mois</strong> (ou 39€ HT/mois en annuel) : 1 établissement, 100 participants/mois, fonctionnalités de base</li>
                            <li><strong>PRO — 69€ HT/mois</strong> (ou 55€ HT/mois en annuel) : 1 établissement, participants illimités, carte fidélité, analytics complets, relance SMS</li>
